...
export default function HomePage() {
  return (
    <>
      ...
      {/* 3. Training Programs Grid */}
      <section className="bg-white py-16 sm:py-24 lg:py-32 border-t border-[rgba(0,0,0,0.08)]">
      ...
      <section className="bg-white py-16 sm:py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          />
          <div className="mt-10 sm:mt-16 grid gap-x-8 sm:gap-x-12 gap-y-8 sm:grid-cols-2 lg:grid-cols-3">
