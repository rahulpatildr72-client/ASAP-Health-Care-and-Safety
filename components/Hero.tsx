    ...
    <section className="relative overflow-hidden bg-[#F4F7FC] pt-32 pb-24 sm:pt-40 lg:py-36 min-h-[90vh] flex items-center">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 lg:px-8 w-full">
        <div className="max-w-xl lg:max-w-2xl">
          {/* Pill Badge */}
          <FadeIn delay={0.1}>
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-100/80 bg-white/90 px-4 py-2 text-xs sm:text-sm font-semibold text-[#1B2559] shadow-sm backdrop-blur-sm mb-6">
          ...
          {/* Headline */}
          <RevealText as="h1" className="font-display text-[2.6rem] sm:text-6xl xl:text-[4.4rem] leading-[1.06] tracking-tight text-[#141414]">
          ...
          {/* Subtitle */}
          <FadeIn delay={0.4}>
            <p className="mt-6 sm:mt-7 max-w-lg text-base sm:text-lg leading-relaxed text-[#1B2559]/90 font-medium sm:font-normal">
          ...
          {/* Action Buttons */}
          <FadeIn delay={0.5}>
            <div className="mt-8 sm:mt-9 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 sm:gap-5">
              <Link
                href="/contact"
          ...
          {/* Subtext */}
          <FadeIn delay={0.6}>
            <p className="mt-8 sm:mt-12 text-xs sm:text-sm font-semibold text-[#1B2559]/75">
