...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    title: "Emergency Response Team (ERT) Awareness Program",
    shortTitle: "ERT Awareness Program",
    category: "emergency",
    ...
    learn: [
      ...
      "Evacuation awareness and procedures",
      ...
      "Post-emergency reporting and review awareness",
    ],
  ...
  },
  {
    ...
    overview: [
      "A safe and respectful workplace is essential for every organization. This awareness program is designed to help participants understand workplace behaviour, professional boundaries and the importance of preventing sexual harassment. The program promotes awareness, respect and responsible conduct while encouraging the creation of a safer and more inclusive working environment.",
    ],
    whoShouldAttend: [
    ...
    learn: [
      ...
      "Awareness of sexual harassment and inappropriate workplace behaviour",
      ...
      "Awareness of reporting and support mechanisms",
      "Creating a safe and positive workplace culture",
      "Prevention through awareness and responsible behaviour",
    ],
    duration: "2–3 Hours",
    modes: ["Onsite", "Classroom", "Live Online"],
    certification:
  ...
  },
  {
    ...
    overview: [
      "Women's health and wellbeing are important aspects of overall personal and workplace wellness. This awareness program is designed to encourage better understanding of female health, self-care and wellbeing across different stages of life. The program promotes awareness and encourages participants to develop healthy habits while understanding the importance of timely support and professional healthcare guidance when needed.",
    ],
    whoShouldAttend: [
      "Women employees, female students, women's groups, organizations, institutions and individuals interested in female health and wellbeing awareness.",
    ],
    learn: [
      "Understanding the importance of female health and wellbeing",
      "Awareness of common women's health concerns",
      ...
      "Awareness of reproductive and menstrual health",
