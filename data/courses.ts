...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    category: "emergency",
    tagline: "Build a certified, battle-ready workplace Emergency Response Team to handle fire, medical, and disaster crises.",
    overview: [
  ...
  },
  {
    ...
    category: "emergency",
    tagline: "Foster a safe, respectful, and compliant workplace through POSH Act awareness and IC committee training.",
    overview: [
